#The main difference between the protected and private methods is that protected methods 
#are accessible from inside the class by using an explicit receiver 
#while private methods are not.
